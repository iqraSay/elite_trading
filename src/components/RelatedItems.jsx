...
import '../App.css';
import demo1 from '../assets/demoKurti.png';
import demo2 from '../assets/demoDress.png';
import demo3 from '../assets/demoGown.png';
import demo4 from '../assets/demoSuit.png';
...
const MayLike = () => {
  ...
  return (
    <div className="py-10 bg-white">
      <h2 className="text-4xl font-bold text-center text-brown-900 mb-8">Check out these related products.</h2>
      <p className="text-center text-lg text-brown-700 mb-10">Trending items that pair perfectly with your chosen style.</p>
      <div className="px-4">
        <Slider {...settings}>
