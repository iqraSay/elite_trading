        ...
        <table className="min-w-full bg-gradient-to-br from-white to-yellow-200 text-brown-900 rounded-3xl shadow-2xl border-none">
            ...
            {filteredUsers.map((user, index) => (
              <tr key={index} className="hover:bg-yellow-500 border-none">
                 <td className="border-none px-4 py-2 text-center">{index + 1}</td>
                <td className="border-none px-4 py-2 text-center">{user.username}</td>
                <td className="border-none px-4 py-2 text-center">{user.email}</td>
                <td className="border-none px-4 py-2 text-center">{user.mobile}</td>
              </tr>
            ))}
