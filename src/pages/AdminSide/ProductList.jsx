...
const ProductList = () => {
  ...
  return (
    <div className='flex'>
      <AdminSidebar />
    <div className="bg-gray-100 text-brown-900 p-6 w-full">
      ...
      <table className="min-w-full bg-gradient-to-br from-white to-yellow-200 text-brown-900 rounded-lg shadow-2xl ">
        ...
        <tbody>
          {filteredProducts.map((product, index) => (
            <tr key={product.id} className="text-center hover:bg-yellow-500">
    ...
    <div className="mb-4">
              ...
              <div className="flex items-center mb-4">
                <input
                  ...
                  onChange={(e) => setSelectedProduct({ ...selectedProduct, offerPrice: e.target.checked ? '' : selectedProduct.offerPrice })}
                  className="mr-2"
                />
