        ...
        <div className="p-4 bg-white min-h-screen">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Link to="/productdisplay/T-Shirt" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
              ...
              <Link to="/productdisplay/Hoodie" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
              ...
              <Link to="/productdisplay/Shoes" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
          ...
          <div className="mb-8">
            ...
            <Link to="/productdisplay/Dress" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
              ...
              <Link to="/productdisplay/Suit" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
              ...
              <Link to="/productdisplay/Kurti" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
              ...
              <Link to="/productdisplay/Gown" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Link to="/productdisplay/Jewelry" className="bg-gradient-to-t from-yellow-200 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-90">
